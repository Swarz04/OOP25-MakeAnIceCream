...
\textbf{Permalink:} \url{[PERMALINK StandardLevel -- registrazione callback]}
...
\textbf{Permalink:} \url{[PERMALINK StandardLevel -- dichiarazione e utilizzo Queue]}
...
\textbf{Permalink:} \url{[PERMALINK PlayerTest / StandardLevelTest -- utilizzo mock e when/verify]}
...
\textbf{Permalink:} \url{[PERMALINK PlayerImpl -- controlli su stato e null]}
\end{itemize}
